                      ...
                      <div key={c.id} className="rec-row">
                        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                          <div>
                            ...
                            <div className="rec-meta">Efectivo: {formatCurrency(c.efectivo)} · Tarjeta: {formatCurrency(c.tarjeta)} · Total: {formatCurrency(c.total_corte)}</div><div className="rec-meta">Egresos: {formatCurrency(c.total_gastos)} · Neto: {formatCurrency((c.total_corte||0)-(c.total_gastos||0))}</div>
